...
class Section(models.Model):
    ...
    def __str__(self):
        return f"id: {self.section_id} for: ({self.user.username})"
...
class Rack(models.Model):
    ...
    def __str__(self):
        return f"id: {self.rack_id}   in section: {self.section.section_id}   for: ({self.user.username})"
...
class ProductLot(models.Model):
    ...
    def __str__(self):
        return f"id: {self.product_lot_id} in rack: {self.rack.rack_id} for: ({self.user.username})"
